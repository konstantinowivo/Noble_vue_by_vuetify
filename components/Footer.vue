  ...
  <v-footer padless class="custom-footer">
    <v-container>
      <v-row align="center" justify="space-between">
        <v-col cols="12" sm="6">
          <p class="footer-text">&copy; 2024 Matafuegos Noble</p>
        </v-col>
      ...
      <!-- Partículas decorativas en el footer -->
...
<style scoped>
.custom-footer {
  background: #111; /* Mantener negro, pero uniforme */
  color: #fff;
  padding: 2rem 0;
  position: relative;
  border-radius: 20px 20px 0 0; /* Bordes redondeados como otros componentes */
  overflow: hidden;
}
...
/* Animación de partículas (igual a los otros componentes) */
@keyframes float {
